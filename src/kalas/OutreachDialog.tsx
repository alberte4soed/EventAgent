  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex max-h-[86vh] w-full max-w-xl flex-col overflow-hidden rounded-3xl border border-[#dcdfdb] bg-[#ffffff] shadow-[0_32px_80px_-16px_rgba(0,0,0,0.28)]"
      >
        <div className="flex items-start justify-between gap-4 border-b border-[#e6e9e5] px-6 py-5">
          <div className="min-w-0">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.18em] text-[#7d938a]">
              {t('Ava skriver til')}
            </p>
            <h2 className="mt-1 truncate font-serif text-[1.3rem] text-[#24413a]">{venueName}</h2>
            {prepared && (
              <div className="mt-2 flex flex-wrap items-center gap-2 text-[0.72rem] text-[#5f6b66]">
                <span className="inline-flex items-center gap-1.5">
                  <Mail size={12} /> {prepared.toEmail}
                </span>
                {langLabel && (
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#e8f0ec] px-2 py-0.5 text-[#24413a]">
          ...
          <button
            ...
            disabled={sending}
            aria-label={t('Luk')}
            className="flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-full text-[#5f6b66] transition-colors hover:bg-[#eceeeb] disabled:opacity-40"
          >
            <X size={16} />
          </button>
        </div>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5">
          {!prepared && !error && (
            <div className="space-y-3 py-8 text-center">
              <div className="mx-auto h-1.5 w-24 animate-pulse rounded-full bg-[#e6e9e5]" />
              <p className="text-[0.85rem] text-[#5f6b66]">{t('Ava skriver henvendelsen…')}</p>
            </div>
          )}
          ...
          {prepared && (
            <div className="space-y-4">
              <label className="block">
                <span className="text-[0.6rem] font-semibold uppercase tracking-[0.18em] text-[#7d938a]">
                  {t('Emne')}
                </span>
                <input
                  value={subject}
                  ...
                  className="mt-1.5 w-full rounded-[12px] border border-[#e6e9e5] bg-white px-3 py-2 text-[0.9rem] text-[#24413a] outline-none focus:border-[#24413a] disabled:opacity-60"
                />
              </label>
              <label className="block">
                <span className="text-[0.6rem] font-semibold uppercase tracking-[0.18em] text-[#7d938a]">
                ...
                <textarea
                  ...
                  disabled={sending || sent}
                  rows={14}
                  className="mt-1.5 w-full resize-y rounded-[12px] border border-[#e6e9e5] bg-white px-3 py-2.5 text-[0.88rem] leading-relaxed text-[#24413a] outline-none focus:border-[#24413a] disabled:opacity-60"
                />
              </label>
              ...
              <div>
                ...
                <div
                  className="mt-1.5 rounded-[12px] border border-dashed border-[#e6e9e5] bg-white px-3 py-3"
        ...
        <div className="flex items-center justify-between gap-3 border-t border-[#e6e9e5] px-6 py-4">
          <p className="text-[0.72rem] text-[#5f6b66]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              onClick={onClose}
              disabled={sending}
              className="h-9 cursor-pointer rounded-full px-4 text-xs font-semibold text-[#5f6b66] transition-colors hover:bg-[#eceeeb] disabled:opacity-40"
            >
              {t('Annuller')}
            </button>
            <button
              ...
              className={cn(
                ...
                sent ? 'bg-[#e8f0ec] text-[#24413a]' : 'bg-[#24413a] text-[#f8f9f8] hover:opacity-85',
