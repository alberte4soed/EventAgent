...
const STEPS: Step[] = [
  ...
  { id: 'inspiration', label: 'Inspiration', title: 'Find jeres stil',
    body: 'Swipe billeder I elsker — Ava former venues og leverandører efter jeres æstetik.' },
  { id: 'venues', label: 'Venues', title: 'Jeres drømmested',
    body: 'Swipe eller fortæl Ava hvad I drømmer om — så finder hun rigtige steder med priser.' },
  { id: 'vendors', label: 'Leverandører', title: 'Hele holdet',
    body: 'Fotograf, blomster, musik og mere — Ava kontakter dem med jeres brief.' },
