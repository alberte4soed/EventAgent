...
/** Short style word shown as the category name in the selector + section headers. */
...
/** Per-category descriptor for the top style selector: a one-line subtitle and
    the template id whose live preview stands in as the category thumbnail. */
export interface GroupMeta {
  subtitle: string;
  representativeId: string;
}

export const GROUP_META: Record<TemplateGroup, GroupMeta> = {
  sealed:    { subtitle: 'Klassisk & forseglet', representativeId: 'sceau' },
  modern:    { subtitle: 'Moderne & rent',       representativeId: 'noir-editorial' },
  botanical: { subtitle: 'Blomster & grønt',     representativeId: 'jardin' },
  color:     { subtitle: 'Farve & sol',          representativeId: 'aquarelle' },
  dramatic:  { subtitle: 'Metallisk & mørk',     representativeId: 'minuit' },
};
